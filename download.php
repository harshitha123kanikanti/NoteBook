<div class="container">
    ...
    <form action="" method="post" class="form-inline">
		<div class="form-group">
			...
			<label for="filter_sub">Subject : </label>
			<select class="form-control" id="filter_sub" name="filter_sub" required>
			  <option value="">Select Subject</option>
				  ...
				  ?>			
				  		...
				  		<option value="<?php echo $row['subjcode']; ?>"<?php if(isset($_POST['go'])){ if($_POST['filter_sub']==$row['code']){ echo " selected"; } } ?>><?php echo $row['subjname']; ?></option>
			...
			<select class="form-control" id="filter_s" name="filter_s" required>
			  <option value="">Select Sem</option>
				  ...
				  ?>			
				  		...
				  		<option value="Even"<?php if(isset($_POST['go'])){ if($_POST['filter_s']=='Even'){ echo " selected"; } } ?>>Even</option>

				  <?php } elseif($i==2){ ?>

				  		<option value="Odd"<?php if(isset($_POST['go'])){ if($_POST['filter_s']=='Odd'){ echo " selected"; } } ?>>Odd</option>

				  <?php } else{ ?>		
				  	
					  	<option value="<?php echo $i; ?>"<?php if(isset($_POST['go'])){ if($_POST['filter_s']==$i){ echo " selected"; } } ?>><?php echo "maths"; ?></option>
